...
// Requires .env with WHATSAPP_TOKEN, PHONE_NUMBER_ID, VERIFY_TOKEN, HMAC_SECRET, PORT (optional)
...
// mask phone for logs: show last 4 only
const maskPhone = (ph) => {
  if (!ph) return "";
  const p = String(ph);
...
// bucket age into range to reduce sensitivity
...
function parseDateInput(input){
  ...
  // Try built-in parse: accept ISO-like and common formats
...
// resolve alias: returns {kind: "alias"|"normal"|"invalid", canonical?}
