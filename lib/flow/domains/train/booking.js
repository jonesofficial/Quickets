...
====================================================== */
    ...
    // Handle AVAILABLE / WL / RAC confirmation
    if (s.state === TRAIN_MANUAL_STATES.AWAITING_CONFIRMATION) {
    ...
    if (s.state === TRAIN_MANUAL_STATES.FARE_SENT) {
      ...
      if (buttonId === "PROCEED_PAYMENT") {
        ...
        await sendText(
          from,
          "💳 Redirecting to payment...\n\nPlease complete the payment to confirm your train ticket.",
        );
    ...
    if (s.state === "TRAIN_CLASS" && ctx.interactiveType === "list_reply") {
    ...
    if (s.state === "TRAIN_QUOTA" && ctx.interactiveType === "list_reply") {
    ...
    if (s.state === "TRAIN_BERTH" && ctx.interactiveType === "list_reply") {
    ...
    if (s.state === "TRAIN_PASSENGERS" && ctx.interactiveType === "list_reply"){
      ...
      /* =========================================
     NORMAL MANUAL FLOW CONTINUES
  ========================================= */

      /* =========================================
     🔥 SAVE TO BOOKING STORE (ONLY ADDITION)
  ========================================= */
      ...
      const savedBooking = saveBooking({
        ...
        from: from, // ✅ WhatsApp chat user
        user: from, // optional duplicate
