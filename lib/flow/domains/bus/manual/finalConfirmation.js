...
const { getLastBookingByUser, findBookingById, updateBooking } = require("../../../../bookingStore");
  ...
  try {
    ...
    if (buttonId === "CONFIRM_BOOKING") {
      ...
      try {
        ...
        console.error("🔥 Failed updating booking status on confirm", {
...
Wait for updated seat selection.`
    ...
    try {
      ...
      console.error("🔥 Failed sending final confirmation buttons", {
        bookingId: booking.id,
        error: err.message,
      });
