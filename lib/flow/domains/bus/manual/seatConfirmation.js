  ...
  try {
    ...
    if (session.state === BUS_STATES.FINAL_CONFIRM) {
      ...
      if (interactiveId === "CHANGE_BUS") {
        ...
        /* 🔥 CRITICAL FIX — MOVE BACK TO SEARCH STATE */
        session.state = BUS_STATES.BUS_SEARCH_PENDING;
