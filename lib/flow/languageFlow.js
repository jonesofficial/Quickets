  ...
  return sendList(
    ...
    [
      ...
      },
      {
        ...
        rows: [
          { id: "LANG_ES", title: "Spanish (Español)" },
          { id: "LANG_FR", title: "French (Français)" },
          { id: "LANG_DE", title: "German (Deutsch)" },
          { id: "LANG_IT", title: "Italian (Italiano)" },
          { id: "LANG_PT", title: "Portuguese (Português)" },
          { id: "LANG_RU", title: "Russian (Русский)" },
          { id: "LANG_AR", title: "Arabic (العربية)" },
          { id: "LANG_TR", title: "Turkish (Türkçe)" },
          { id: "LANG_JA", title: "Japanese (日本語)" },
          { id: "LANG_KO", title: "Korean (한국어)" }
        ]
      }
    ]
  );
