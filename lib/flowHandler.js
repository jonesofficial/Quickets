...
const optionSets = {
  ...
  ta: {
    ...
    MENU_BOOK: "பேருந்து டிக்கெட் புக்",
    MENU_TRACK: "புக் நிலை காண்க",
    MENU_MYBOOK: "எனது புக்குகள்",
    ...
    ASK_FROM: "புறப்படும் நகரம்? (ஆங்கிலத்தில் எழுதவும்)",
    ASK_TO: "செல்லும் நகரம்? (ஆங்கிலத்தில் எழுதவும்)",
    ...
    PASSENGER_BULK_EXAMPLE:
      "ஒவ்வொரு வரியிலும்: name age gender — ஆங்கிலத்தில்.\nஎ.கா:\nVikram 28 M\nSita 26 F",

    NEED_EXACT_PAX: "*{{want}}* பேர் வேண்டும்.\nநீங்கள் *{{have}}* பேரை அனுப்பியுள்ளீர்கள்.",

    COULDNT_PARSE_PASS: "வடிவம் பிழை.\nஉதாரணம்: Aarav 28 M",

    ADDED_PASSENGERS: "{{count}} பயணிகள் சேர்க்கப்பட்டது.",
    ...
    CONFIRM_BOOKING_PROMPT: "புக் உறுதிப்படுத்தலாமா?",
    CONFIRM_BOOK: "உறுதிப்படுத்து",
    EDIT_BOOK: "மாற்று",
    CANCEL_BOOK: "ரத்து செய்",

    CONFIRMED_BOOKING: "✅ *உறுதிப்படுத்தப்பட்டது*\nபுக் ஐடி: *{{id}}*.",
    CANCELLED: "புக் ரத்து செய்யப்பட்டது.",

    TRACK_PROMPT: "புக் ஐடி எழுதவும்.",
    NO_BOOKING_FOUND: "*{{id}}* கிடைக்கவில்லை.",

    YOUR_BOOKINGS_NONE: "புக்குகள் எதுவும் இல்லை.",
    YOUR_BOOKINGS_LIST: "*உங்கள் புக்குகள்:*\n{{lines}}",
    ...
    BUDGET_PROMPT: "உங்கள் பட்ஜெட்டை தேர்வு:",
