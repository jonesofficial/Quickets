...
/* ======================================================
 * Admin Command Handler (STRICT BUS ONLY)
 * ====================================================== */
...
async function handleAdminCommands(ctx) {
  ...
  /* ==========================================
     4️⃣ ALL OTHER COMMANDS REQUIRE ACTIVE BOOKING
  ========================================== */
  ...
  /* ==========================================
     5️⃣ BOOKING STATUS UPDATE
  ========================================== */

  if (BOOKING_COMMANDS[command]) {

    if (command === "CONFIRM" && !booking.payment) {
      await sendText(
        from,
        "⚠️ Cannot CONFIRM yet.\nPayment not completed."
      );
