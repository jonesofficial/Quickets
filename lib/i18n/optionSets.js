const optionSets = {
  ...
  en: {
    ...
    BUS_CITY_NOT_UNDERSTOOD: "❌ City not understood. Try again.",
    BUS_INVALID_NUMBER: "❌ Invalid number. Please choose from the list.",
    BUS_FROM_TO_SAME: "❌ From and To cities cannot be the same.",
  ...
  ta: {
    ...
    MENU_BOOK: "🎟 டிக்கெட் பதிவு செய்யவும்",
    MENU_TRACK: "🔍 பதிவு நிலை பார்க்க",
    MENU_HELP: "உதவி & ஆதரவு",
    MENU_ABOUT: "எங்களை பற்றி",
    ...
    BUS_TITLE: "🚌 *பேருந்து முன்பதிவு*",

    BUS_FROM_PROMPT:
      "📍 *எந்த நகரத்தில் இருந்து பயணம்?*\n\n" +
      "✍️ நகரத்தின் பெயரை உள்ளிடவும் (உதா: *சென்னை*)\n" +
      "🔢 பட்டியல் இருந்தால் எண்ணை பதிலளிக்கவும்\n\n" +
      "_Progress: 1 / 7_",

    BUS_TO_PROMPT:
      "📍 *செல்லும் நகரம்?*\n\n" +
      "✍️ நகரத்தின் பெயரை உள்ளிடவும்\n" +
      "🔢 எண்ணை பதிலளிக்கலாம்\n\n" +
      "⚠️ புறப்படும் & செல்லும் நகரம் ஒரேதாக இருக்கக்கூடாது\n\n" +
      "_Progress: 2 / 7_",

    BUS_DATE_PROMPT:
      "📅 *பயண தேதி*\n\nபயண தேதியை தேர்வு செய்யவும்\n\n_Progress: 3 / 7_",

    BUS_TIME_PROMPT:
      "⏰ *விரும்பும் புறப்படும் நேரம்*\n\nநேரத்தைத் தேர்வு செய்யவும்\n\n_Progress: 4 / 7_",

    BUS_PAX_PROMPT:
      "👥 *பயணிகள் எண்ணிக்கை*\n\nஒரு டிக்கெட் = ஒரு பயணி\n\n_Progress: 5 / 7_",

    BUS_SEAT_PROMPT:
      "💺 *இருக்கை விருப்பம்*\n\n" +
      "🛏 ஸ்லீப்பர் → நீண்ட பயணம்\n" +
      "🪑 சீட்டர் → குறுகிய பயணம்\n\n" +
      "_Progress: 6 / 7_",

    BUS_BUDGET_PROMPT:
      "💰 *ஒரு இருக்கைக்கான பட்ஜெட்*\n\n" +
      "சிறந்த பேருந்துகளை தேடுகிறோம்\n\n" +
      "_Progress: 7 / 7_",

    BUS_CITY_NOT_UNDERSTOOD: "❌ நகரம் புரியவில்லை. மீண்டும் முயற்சிக்கவும்.",
    BUS_INVALID_NUMBER: "❌ தவறான எண். பட்டியலில் இருந்து தேர்வு செய்யவும்.",
    BUS_FROM_TO_SAME: "❌ புறப்படும் & செல்லும் நகரம் ஒரேதாக இருக்கக்கூடாது.",
  },
  ...
  hi: {
    ...
    BUS_FROM_PROMPT:
      "📍 *आप किस शहर से यात्रा कर रहे हैं?*\n\n" +
      "✍️ शहर का नाम लिखें (उदा: *चेन्नई*)\n" +
      "🔢 सूची होने पर संख्या भेजें\n\n" +
      "_Progress: 1 / 7_",

    BUS_TO_PROMPT:
      "📍 *गंतव्य शहर?*\n\n" +
      "✍️ शहर का नाम लिखें\n" +
      "🔢 संख्या से भी चुन सकते हैं\n\n" +
      "⚠️ प्रस्थान और गंतव्य एक नहीं हो सकते\n\n" +
      "_Progress: 2 / 7_",

    BUS_DATE_PROMPT:
      "📅 *यात्रा तिथि*\n\nयात्रा तिथि चुनें\n\n_Progress: 3 / 7_",

    BUS_TIME_PROMPT: "⏰ *प्रस्थान समय पसंद*\n\nसमय चुनें\n\n_Progress: 4 / 7_",
    ...
    BUS_BUDGET_PROMPT:
      "💰 *प्रति सीट बजट*\n\n" +
      "हम सबसे अच्छी बसें खोजेंगे\n\n" +
      "_Progress: 7 / 7_",

    BUS_CITY_NOT_UNDERSTOOD: "❌ शहर समझ में नहीं आया। पुनः प्रयास करें।",
    BUS_INVALID_NUMBER: "❌ गलत संख्या। सूची से चुनें।",
    BUS_FROM_TO_SAME: "❌ प्रस्थान और गंतव्य शहर एक नहीं हो सकते।",
  },
};
